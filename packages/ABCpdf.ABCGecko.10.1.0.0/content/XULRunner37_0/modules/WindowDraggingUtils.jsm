...
//@line 10 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 17 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
  if (!this.isPanel())
    this._elem.addEventListener("MozMouseHittest", this, false);
  else
//@line 21 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 64 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
    if (!isPanel) {
      if (this.shouldDrag(aEvent))
        aEvent.preventDefault();
      return;
    }
//@line 70 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 81 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
        if (isPanel) {
...
//@line 94 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\toolkit\modules\WindowDraggingUtils.jsm"
        break;
      case "mousemove":
