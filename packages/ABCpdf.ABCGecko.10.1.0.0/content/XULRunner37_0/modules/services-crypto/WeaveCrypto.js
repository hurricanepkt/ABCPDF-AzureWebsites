...
WeaveCrypto.prototype = {
    ...
    initNSS : function() {
        ...
        var nsslib;
//@line 140 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\services\crypto\modules\WeaveCrypto.js"
        let file = Services.dirsvc.get("GreBinD", Ci.nsILocalFile);
        file.append(path);
        this.log("Trying NSS library with path " + file.path);
        nsslib = ctypes.open(file.path);
//@line 145 "c:\WSG\Projects\ABCpdf\Source\mozilla-release\services\crypto\modules\WeaveCrypto.js"
